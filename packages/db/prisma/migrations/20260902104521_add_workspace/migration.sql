...
ALTER TYPE "RepositoryProvider" ADD VALUE 'GITLAB';
ALTER TYPE "RepositoryProvider" ADD VALUE 'BITBUCKET';

-- DropIndex
DROP INDEX "TaskParameter_organizationId_idx";
...
-- AlterTable
ALTER TABLE "RemediationCase" ADD COLUMN     "workspaceId" TEXT;

-- AlterTable
ALTER TABLE "Repository" ADD COLUMN     "workspaceId" TEXT;
...
-- CreateIndex
CREATE INDEX "Notification_organizationId_workspaceId_createdAt_idx" ON "Notification"("organizationId", "workspaceId", "createdAt" DESC);

-- CreateIndex
CREATE INDEX "RemediationCase_workspaceId_idx" ON "RemediationCase"("workspaceId");
...
-- AddForeignKey
ALTER TABLE "RemediationCase" ADD CONSTRAINT "RemediationCase_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE SET NULL ON UPDATE CASCADE;
