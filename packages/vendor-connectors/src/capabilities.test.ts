...
describe("connector capability registry", () => {
  ...
  it("openai/stripe/twilio/anthropic/supabase/vercel-ai-sdk/openai-python/google-gemini/autonomous-generic are certified DRAFT_PR; aws-sdk is PLAN; auth0 is PLAN; the rest are ASSESS", () => {
